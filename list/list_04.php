...
if (!empty($_GET['search'])) {
    ...
    $data = $_GET['search'];
    //
    $sql = "SELECT * FROM tb_cad03 WHERE
        id LIKE '%$data%' 
        or nome LIKE '%$data%' 
        or email LIKE '%$data%'
        or idade LIKE '%$data%'
    ...
    $sql = "SELECT * FROM tb_cad03 ORDER BY id ASC";
}
...
<body id="fundoList">
    ...
    <div style="margin-top: -86px;margin-left:910px;">
        <button class="btn btn-danger">
            <a id="likDel" style="text-decoration-color:red;" href='delete_04.php?id=$user_data[ID]'>
    ...
    <table class="table" style="width: 500px;margin-left:16px;">
        ...
        <tbody>
            ...
            while ($user_data = mysqli_fetch_assoc($result)) {
                ...
                echo "<td>
                <a class='btn btn-primary' style='margin-top:50px;' href='edit_04.php?id=$user_data[ID]'><i class='bi bi-pencil-square'></i></a></td>";
                /*BUTTON editar linha */
                echo "<td>
                <a class='btn btn-danger' style='margin-left:-66px;margin-top:-0px;' href='exclu_04.php?id=$user_data[ID]'><i class='bi bi-trash3'></i></a>
                </td>";
                /*BUTTON editar linha */
                echo "</tr>";
            }
...
<script>
    ...
    function searchData() {
        //Alterando a URl
        window.location = 'list_04.php?search=' + search.value;
    }
</script>
